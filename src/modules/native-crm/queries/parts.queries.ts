...
const BASE = '/api/v1/native-crm/parts';
const KEY  = ['native-crm', 'parts'] as const;
...
export function usePartsListQuery(params: ListParams) {
  return useQuery({
    queryKey: [...KEY, params],
    queryFn: () =>
