...
export default function InvoicePrintPage() {
  ...
  if (!item) return <div className="flex items-center justify-center h-screen text-gray-500">Invoice not found.</div>;
    ...
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className={`w-[210mm] min-h-[297mm] mx-auto my-8 print:my-0 bg-white shadow-xl print:shadow-none p-[15mm] font-sans text-sm text-gray-800 ${a4Cls}${editing ? ' outline outline-2 outline-brand-400 outline-offset-4' : ''}`}>
          ...
          <div className="text-right">
            ...
            <div className="text-xs text-gray-600 space-y-0.5 mt-2">
              ...
              <div className="flex justify-end gap-1.5 mt-1">
                ...
                {item.paid && <span className="inline-flex px-2 py-0.5 rounded-full text-xs font-semibold bg-green-600 text-white">PAID</span>}
              </div>
            </div>
          </div>
        </div>
        ...
        {settings?.invoiceFooter && (
          <p className="text-xs text-gray-400 border-t border-gray-200 pt-3 mb-6 whitespace-pre-line text-center">{settings.invoiceFooter}</p>
        )}
