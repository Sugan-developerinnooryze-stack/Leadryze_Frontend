...
export default function CategoriesPage() {
  ...
  const { data: result, isLoading, error } = useCategoriesListQuery({ page, limit: 20, search: search || undefined, status: status || undefined });
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {drawer.open && (
        <FSDrawer
          title={drawer.record?._id ? 'Edit Category' : 'New Category'}
          fields={FIELDS}
